        ...
        <div className="h-16 px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <motion.button
              ...
              className="p-3 rounded-2xl hover:bg-white/10 active:bg-white/20 
            ...
            >
              <motion.div 
                ...
                className="bg-white/10 backdrop-blur-md p-2.5 rounded-2xl border border-white/20 
                            hover:bg-white/20 transition-all duration-300 shadow-inner"
              >
                <img
          ...
          <div className="hidden md:block">
            <motion.h1
              ...
              onClick={() => navigate("/dashboard")}
              className="text-xl font-bold text-white tracking-[4px] uppercase cursor-pointer 
                         hover:text-emerald-100 transition-all duration-300 hover:tracking-widest"
            >
              NAGAR SAHAYATA
            </motion.h1>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              className="relative p-3 rounded-2xl hover:bg-white/10 active:bg-white/20 
                         transition-all duration-200 text-white cursor-pointer"
            >
              ...
              {notificationCount > 0 && (
                <motion.span 
                  ...
                  className="absolute -top-1 -right-1 bg-red-500 text-white text-xs font-bold 
                             w-5 h-5 flex items-center justify-center rounded-full ring-2 ring-white shadow"
                >
                  {notificationCount}
                </motion.span>
              )}
